...
function createTextTexture(gl, text, font = "bold 30px monospace", color = "black") {
  ...
  canvas.height = (textHeight + 20) * pixelRatio
  ...
  return { texture, width: canvas.width / pixelRatio, height: canvas.height / pixelRatio }
}

class Title {
  constructor({ gl, plane, renderer, text, textColor = "#545050", font = "24px -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif" }) {
    autoBind(this)
    this.gl = gl
    this.plane = plane
...
export default function CircularGallery({
  ...
  textColor = "#f97316",
  borderRadius = 0.05,
  font = "bold 24px -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif"
}) {
