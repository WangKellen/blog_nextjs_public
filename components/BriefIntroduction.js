    ...
    <section className="container mx-auto px-4 py-24">
      ...
      >
        ...
        <motion.div {...fadeInUp} className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-800 dark:text-white/90 text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div 
            {...fadeInUp}
            className="relative bg-white/10 backdrop-blur-lg rounded-xl p-6 shadow-xl border border-gray-200/20 dark:border-white/10 group hover:bg-white/20 transition-all duration-300"
          >
        ...
        <motion.div 
          {...fadeInUp}
          className="bg-white/10 backdrop-blur-lg rounded-xl p-8 shadow-xl border border-gray-200/20 dark:border-white/10"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-700 dark:text-white/80">设计开发多款AIGC工具，赋能高校教育教学及教师办公效率提升</p>
            </div>
            <div className="p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
              <h4 className="text-lg font-semibold mb-2 text-orange-400">XR虚拟展厅</h4>
              <p className="text-gray-700 dark:text-white/80">为企业打造数字化展示平台，提供沉浸式体验解决方案</p>
            </div>
            <div className="p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-300">
              <h4 className="text-lg font-semibold mb-2 text-orange-400">无人机虚拟仿真训练系统</h4>
              <p className="text-gray-700 dark:text-white/80">为无人机相关专业学生提供基础训练，助力高校降本增效</p>
            </div>
          </div>
        </motion.div>
      </motion.div>
